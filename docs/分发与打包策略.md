...
截至 2026-07-23，`0.1.45` 已按以下链路完成 macOS ARM64 内网更新验证。2.26 更新源为 `http://192.168.2.26:3988/desktop-updates`，服务器目录为 `/root/.virtual-resource-console/desktop-updates/`。
...
scp -i ~/.ssh/id_ed25519 \
  ...
  "apps/electron/dist/VRC-${VERSION}-arm64.dmg" \
  "apps/electron/dist/VRC-${VERSION}-arm64.dmg.blockmap" \
  root@192.168.2.26:/root/.virtual-resource-console/desktop-updates/

scp -i ~/.ssh/id_ed25519 \
  apps/electron/dist/latest-mac.yml \
  root@192.168.2.26:/root/.virtual-resource-console/desktop-updates/latest-mac.yml
```
...
ssh -i ~/.ssh/id_ed25519 root@192.168.2.26 \
  "sha256sum /root/.virtual-resource-console/desktop-updates/VRC-${VERSION}-arm64-mac.zip"
curl -fsS http://192.168.2.26:3988/desktop-updates/latest-mac.yml
curl -fsSI "http://192.168.2.26:3988/desktop-updates/VRC-${VERSION}-arm64-mac.zip"
```
