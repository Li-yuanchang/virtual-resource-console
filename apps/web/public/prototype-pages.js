(() => {
  ...
  function initResourceList() {
    const hostRows = [
      { id: "h1", name: "xenserver-01", address: "192.0.2.31", platform: "XenServer", state: "online", cpuUsage: 43, cpuCores: 56, memoryFree: 67.8, memoryTotal: 191.8, storageFree: 1834, storageTotal: 15366, runningVms: 18, totalVms: 22, updatedAt: "刚刚" },
      { id: "h2", name: "xenserver-02", address: "192.0.2.32", platform: "XenServer", state: "warning", cpuUsage: 82, cpuCores: 48, memoryFree: 18.2, memoryTotal: 128, storageFree: 420, storageTotal: 8192, runningVms: 21, totalVms: 24, updatedAt: "12 秒前" },
      { id: "h3", name: "pve-node-01", address: "192.0.2.41", platform: "Proxmox VE", state: "online", cpuUsage: 36, cpuCores: 64, memoryFree: 94.6, memoryTotal: 256, storageFree: 2960, storageTotal: 12288, runningVms: 15, totalVms: 19, updatedAt: "20 秒前" },
      { id: "h4", name: "pve-node-02", address: "192.0.2.42", platform: "Proxmox VE", state: "online", cpuUsage: 59, cpuCores: 64, memoryFree: 72.1, memoryTotal: 256, storageFree: 1640, storageTotal: 12288, runningVms: 17, totalVms: 18, updatedAt: "24 秒前" },
      { id: "h5", name: "esxi-prod-01", address: "192.0.2.51", platform: "VMware", state: "warning", cpuUsage: 76, cpuCores: 48, memoryFree: 11.4, memoryTotal: 192, storageFree: 780, storageTotal: 10240, runningVms: 25, totalVms: 27, updatedAt: "31 秒前" },
      { id: "h6", name: "esxi-prod-02", address: "192.0.2.52", platform: "VMware", state: "online", cpuUsage: 28, cpuCores: 48, memoryFree: 88.7, memoryTotal: 192, storageFree: 3420, storageTotal: 10240, runningVms: 12, totalVms: 16, updatedAt: "35 秒前" },
